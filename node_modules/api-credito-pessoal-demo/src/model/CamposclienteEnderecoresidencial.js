...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ApiCrditoPessoalDemo.CamposclienteEnderecoresidencial = factory(root.ApiCrditoPessoalDemo.ApiClient);
  }
  ...
  /**
   * The CamposclienteEnderecoresidencial model module.
   * @module model/CamposclienteEnderecoresidencial
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>CamposclienteEnderecoresidencial</code>.
   * @alias module:model/CamposclienteEnderecoresidencial
   * @class
   */
  ...
  /**
   * Constructs a <code>CamposclienteEnderecoresidencial</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CamposclienteEnderecoresidencial} obj Optional instance to populate.
   * @return {module:model/CamposclienteEnderecoresidencial} The populated <code>CamposclienteEnderecoresidencial</code> instance.
   */
