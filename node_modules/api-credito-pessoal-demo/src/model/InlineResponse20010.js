...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CamposCliente'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CamposCliente'));
  } else {
    // Browser globals (root is window)
    if (!root.ApiCrditoPessoalDemo) {
      root.ApiCrditoPessoalDemo = {};
    }
    root.ApiCrditoPessoalDemo.InlineResponse20010 = factory(root.ApiCrditoPessoalDemo.ApiClient, root.ApiCrditoPessoalDemo.CamposCliente);
  }
}(this, function(ApiClient, CamposCliente) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('cliente')) {
        obj['cliente'] = CamposCliente.constructFromObject(data['cliente']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/CamposCliente} cliente
   */
  exports.prototype['cliente'] = undefined;
