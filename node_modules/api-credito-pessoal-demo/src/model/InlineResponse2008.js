...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ApiCrditoPessoalDemo.InlineResponse2008 = factory(root.ApiCrditoPessoalDemo.ApiClient);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('contrato')) {
  ...
  /**
   * Número do Contrato na portocred
   * @member {String} contrato
   */
  exports.prototype['contrato'] = undefined;
  /**
   * Situação do contrato após cancelamento
